...
import fila.products.ProductsOptionDTO;
...
public class ProductService {
    ...
    public void getProductDetail(HttpServletRequest request) {
        ...
        try {
            ...
            // ReviewDAO 객체 생성
            fila.review.ReviewDAO reviewDao = new fila.review.ReviewDAOImpl(conn);
            ...
            if (dto != null) {
                ...
                fila.member.MemberDTO auth = (fila.member.MemberDTO) session.getAttribute("auth");
                ...
                List<fila.review.ReviewDTO> reviewList = reviewDao.selectListByFilter(productId, null, userNumber, null, null);
                java.util.Map<String, Object> reviewSummary = reviewDao.getReviewSummary(productId);
                fila.qna.QnaDAO qnaDao = fila.qna.QnaDAOImpl.getInstance(); 
                java.util.List<fila.qna.QnaDTO> qnaList = qnaDao.selectList(productId);
